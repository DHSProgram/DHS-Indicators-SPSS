...
*****************************************************************************************************
Program: 			RC_tables_MR.sps
Purpose: 			produce tables for indicators
Author:				Ivana Bjelic
Date last modified: October 16 2019 by Ivana Bjelic

*This do file will produce the following tables in excel:
	1.             Tables_background_mn:	                  Contains the tables for background variables for men
	2.             Tables_educ_mn:		Contains the tables for education indicators for women
	3.             Tables_media_mn:		Contains the tables for media exposure and internet use for men
	4.             Tables_employ_mn:		Contains the tables for employment and occupation indicators for men
	5.             Tables_insurance_mn:	                  Contains the tables for health insurance indicators for men
	6.             Tables_tobac_mn:		Contains the tables for tobacco use indicators for men

*Notes: For men the indicators are outputed for age 15-49 in line 30. 
...
**************************************************************************************************
****************************************************.
frequencies variables =mv013 mv501 mv025 mv106 mv024 mv190.	

****************************************************
* Export Output.
output export
  /contents  export=visible  layers=printsetting  modelviews=printsetting
  /xls  documentfile="Tables_background_mn.xls"
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv190 by rc_edu
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv190 by rc_litr_cats
    /format = avalue tables
    /cells = row 
    /count asis.
****************************************************
...
output export
  /contents  export=visible  layers=printsetting  modelviews=printsetting
  /xls  documentfile="Tables_educ_mn.xls"
     operation=createfile.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_media_newsp
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_media_tv
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_media_radio
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_media_allthree
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_media_none
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_intr_ever
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_intr_use12mo
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_intr_usefreq
    /format = avalue tables
    /cells = row 
    /count asis.
...
output export
  /contents  export=visible  layers=printsetting  modelviews=printsetting
  /xls  documentfile="Tables_media_mn.xls"
     operation=createfile.
...
*crosstabs 
    /tables = mv013 mv502 mv025 mv024 mv106 mv190 by rc_empl
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv502 mv025 mv024 mv106 mv190 by rc_occup
    /format = avalue tables
    /cells = row 
    /count asis.
...
+recode mv717 (1 thru 3,6 thru 9, 96 thru 99, sysmis=0) (4,5=1) into agri.
end if.
...
output export
  /contents  export=visible  layers=printsetting  modelviews=printsetting
  /xls  documentfile="Tables_employ_mn.xls"
     operation=createfile.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_hins_ss
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_hins_empl
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_hins_comm
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_hins_priv
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_hins_other
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_hins_any
    /format = avalue tables
    /cells = row 
    /count asis.
...
output export
  /contents  export=visible  layers=printsetting  modelviews=printsetting
  /xls  documentfile="Tables_insurance_mn.xls"
     operation=createfile.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_tobc_cig
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_tobc_other
    /format = avalue tables
    /cells = row 
    /count asis.
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_tobc_smk_any
    /format = avalue tables
    /cells = row 
    /count asis.
...
ctables
  /table  mv013 [c]
         ...
         + mv106 [c]
         + mv190 [c] by
         rc_smk_freq [c] [rowpct.validn '' f5.1] + num [s] [sum,'', f5.0]
  /categories variables=all empty=exclude missing=exclude
  /categories variables=all total=yes position=after label="Total"
  /slabels visible=no
  /titles title=
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_smk_freq
    /format = avalue tables
    /cells = row 
    /count asis.
...
ctables
  /table  mv013 [c]
         ...
         + mv106 [c]
         + mv190 [c] by
         rc_cig_day [c] [rowpct.validn '' f5.1] + rc_cig_day [s] [validn,'', f5.0]
  /categories variables=all empty=exclude missing=exclude
  /categories variables=all total=yes position=after label="Total"
  /slabels visible=no
  /titles title=
...
*crosstabs 
    /tables = mv013 mv025 mv024 mv106 mv190 by rc_cig_day
    /format = avalue tables
    /cells = row 
    /count asis.
...
output export
  /contents  export=visible  layers=printsetting  modelviews=printsetting
  /xls documentfile="Tables_tobac_mn.xls"
     operation=createfile.
